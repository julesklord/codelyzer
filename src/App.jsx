            ...
            React.createElement('div',{className:'canvas-area'},
                ...
                React.createElement(React.Fragment,null,
                    ...
                    graphConfig.vizType!=='architecture'&&React.createElement('div',{className:'legend'+(legendCollapsed?' collapsed':'')},
                        React.createElement('div',{className:'legend-header',role:'button',tabIndex:0,'aria-expanded':!legendCollapsed,onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();setLegendCollapsed(!legendCollapsed);}},onClick:function(){setLegendCollapsed(!legendCollapsed);}},
                        ...
                        rightTab==='details'&&(selected?React.createElement(React.Fragment,null,
                            ...
                            (function(){
                                ...
                                return totalConns>0&&React.createElement('div',{className:'card',style:{marginBottom:12}},
                                    React.createElement('div',{className:'card-header',role:'button',tabIndex:0,'aria-expanded':expandedCards.has('conns'),onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();toggleCard('conns');}},onClick:function(){toggleCard('conns');}},React.createElement('div',{className:'card-title'},React.createElement('span',{className:'card-toggle'+(expandedCards.has('conns')?' open':'')},'▶'),React.createElement(Icon,{name:'link',size:'s'}),' Connections'),React.createElement('span',{className:'badge badge-default'},totalConns)),
                                    expandedCards.has('conns')&&React.createElement('div',{className:'card-body',style:{padding:0}},
                                        outgoing.length>0&&React.createElement(React.Fragment,null,
                                            ...
                                            outgoing.slice(0,15).map(function(conn){
                                                ...
                                                return React.createElement('div',{key:conn.file,className:'conn-item'},
                                                    React.createElement('div',{className:'conn-header',role:'button',tabIndex:0,'aria-expanded':isOpen,onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();e.stopPropagation();toggleCard('conn-out-'+conn.file);}},onClick:function(e){e.stopPropagation();toggleCard('conn-out-'+conn.file);}},
                                        ...
                                        incoming.length>0&&React.createElement(React.Fragment,null,
                                            ...
                                            incoming.slice(0,15).map(function(conn){
                                                ...
                                                return React.createElement('div',{key:conn.file,className:'conn-item'},
                                                    React.createElement('div',{className:'conn-header',role:'button',tabIndex:0,'aria-expanded':isOpen,onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();e.stopPropagation();toggleCard('conn-in-'+conn.file);}},onClick:function(e){e.stopPropagation();toggleCard('conn-in-'+conn.file);}},
                                                        React.createElement('span',{className:'card-toggle'+(isOpen?' open':''),style:{fontSize:8,marginRight:6}},'▶'),
                                                        React.createElement('span',{className:'conn-file-icon'},React.createElement(Icon,{name:'file',size:'s'})),
                                                        React.createElement('span',{className:'conn-file-name'},conn.file.split('/').pop()),
                                                        React.createElement('span',{className:'badge badge-default',style:{marginLeft:'auto'}},conn.fns.length,' fn',conn.fns.length!==1?'s':'')
                            ...
                            React.createElement('div',{className:'card',style:{marginBottom:12}},
                                React.createElement('div',{className:'card-header',role:'button',tabIndex:0,'aria-expanded':expandedCards.has('own'),onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();toggleCard('own');}},onClick:function(){toggleCard('own');}},React.createElement('div',{className:'card-title'},React.createElement('span',{className:'card-toggle'+(expandedCards.has('own')?' open':'')},'▶'),React.createElement(Icon,{name:'users',size:'s'}),' Ownership')),
                            ...
                            React.createElement('div',{className:'card'},
                                React.createElement('div',{className:'card-header',role:'button',tabIndex:0,'aria-expanded':expandedCards.has('fns'),onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();toggleCard('fns');}},onClick:function(){toggleCard('fns');}},React.createElement('div',{className:'card-title'},React.createElement('span',{className:'card-toggle'+(expandedCards.has('fns')?' open':'')},'▶'),React.createElement(Icon,{name:'bolt',size:'s'}),' Functions (',selected.functions.length,')')),
                                expandedCards.has('fns')&&React.createElement('div',{className:'card-body',style:{padding:8}},
                                    ...
                                    selected.functions.map(function(fn){
                                        ...
                                        return React.createElement('div',{key:fn.name,className:'fn-item'},
                                            React.createElement('div',{className:'fn-header',role:'button',tabIndex:0,'aria-expanded':expandedFns.has(fn.name),onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();toggleFn(fn.name);}},onClick:function(){toggleFn(fn.name);}},
                ...
                React.createElement('div',{className:'modal-body',style:{maxHeight:'70vh',overflowY:'auto'}},
                    ...
                    data.deadFunctions.map(function(fn,i){
                        ...
                        return React.createElement('div',{key:i,className:'unused-fn'},
                            React.createElement('div',{className:'unused-fn-header',role:'button',tabIndex:0,'aria-expanded':expandedFns.has('dead-'+fn.name),onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();toggleFn('dead-'+fn.name);}},onClick:function(){toggleFn('dead-'+fn.name);}},
                                React.createElement('div',null,
