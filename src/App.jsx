                ...
                React.createElement('div',{className:'modal-body'},
                    data&&data.architectureDiagram&&React.createElement(React.Fragment,null,
                        ...
                        React.createElement('div',{className:'export-options'},
                            React.createElement('div',{className:'export-option',role:'button',tabIndex:0,onClick:function(){copyMermaid();setShowExport(false);},onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();copyMermaid();setShowExport(false);}}},React.createElement('div',{className:'export-option-icon'},React.createElement(Icon,{name:'copy',size:'xl'})),React.createElement('div',{className:'export-option-label'},'Copy Mermaid')),
                            React.createElement('div',{className:'export-option',role:'button',tabIndex:0,onClick:function(){downloadMermaid();setShowExport(false);},onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();downloadMermaid();setShowExport(false);}}},React.createElement('div',{className:'export-option-icon'},React.createElement(Icon,{name:'code',size:'xl'})),React.createElement('div',{className:'export-option-label'},'Mermaid File')),
                            React.createElement('div',{className:'export-option',role:'button',tabIndex:0,onClick:function(){downloadArchitectureSVG();setShowExport(false);},onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();downloadArchitectureSVG();setShowExport(false);}}},React.createElement('div',{className:'export-option-icon'},React.createElement(Icon,{name:'image',size:'xl'})),React.createElement('div',{className:'export-option-label'},'Diagram SVG'))
                        )
                    ),
                    graphConfig.vizType!=='architecture'&&React.createElement(React.Fragment,null,
                        ...
                        React.createElement('div',{className:'export-options'},
                            React.createElement('div',{className:'export-option',role:'button',tabIndex:0,onClick:function(){exportSVG();setShowExport(false);},onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();exportSVG();setShowExport(false);}}},React.createElement('div',{className:'export-option-icon'},React.createElement(Icon,{name:'image',size:'xl'})),React.createElement('div',{className:'export-option-label'},'SVG Image')),
                            React.createElement('div',{className:'export-option',role:'button',tabIndex:0,onClick:function(){exportPDF();setShowExport(false);},onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();exportPDF();setShowExport(false);}}},React.createElement('div',{className:'export-option-icon'},React.createElement(Icon,{name:'file-pdf',size:'xl'})),React.createElement('div',{className:'export-option-label'},'PDF Document')),
                            React.createElement('div',{className:'export-option',role:'button',tabIndex:0,onClick:function(){copyLink();setShowExport(false);},onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();copyLink();setShowExport(false);}}},React.createElement('div',{className:'export-option-icon'},React.createElement(Icon,{name:'link',size:'xl'})),React.createElement('div',{className:'export-option-label'},'Share Link'))
                        )
                    ),
                    ...
                    React.createElement('div',{className:'export-options'},
                        React.createElement('div',{className:'export-option',role:'button',tabIndex:0,onClick:function(){generateReport('json');setShowExport(false);},onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();generateReport('json');setShowExport(false);}}},React.createElement('div',{className:'export-option-icon'},React.createElement(Icon,{name:'code',size:'xl'})),React.createElement('div',{className:'export-option-label'},'JSON Report')),
                        React.createElement('div',{className:'export-option',role:'button',tabIndex:0,onClick:function(){generateReport('md');setShowExport(false);},onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();generateReport('md');setShowExport(false);}}},React.createElement('div',{className:'export-option-icon'},React.createElement(Icon,{name:'note',size:'xl'})),React.createElement('div',{className:'export-option-label'},'Markdown')),
                        React.createElement('div',{className:'export-option',role:'button',tabIndex:0,onClick:function(){generateReport('txt');setShowExport(false);},onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();generateReport('txt');setShowExport(false);}}},React.createElement('div',{className:'export-option-icon'},React.createElement(Icon,{name:'file',size:'xl'})),React.createElement('div',{className:'export-option-label'},'Plain Text'))
                    ),
                    ...
                    React.createElement('div',{className:'export-options'},
                        React.createElement('div',{className:'export-option',role:'button',tabIndex:0,onClick:function(){exportJSON();setShowExport(false);},onKeyDown:function(e){if(e.key==='Enter'||e.key===' '){e.preventDefault();exportJSON();setShowExport(false);}}},React.createElement('div',{className:'export-option-icon'},React.createElement(Icon,{name:'settings',size:'xl'})),React.createElement('div',{className:'export-option-label'},'Raw JSON'))
                    )
                )
            )
        ),
